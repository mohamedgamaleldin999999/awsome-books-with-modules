...
test('DateTime.fromStringExplain is an alias for DateTime.fromFormatExplain', () => {
  ...
  const fs = DateTime.fromFormatExplain('1982/05/25 09:10:11.445', 'yyyy/MM/dd HH:mm:ss.SSS')
...
test('DateTime.fromString is an alias for DateTime.fromFormat', () => {
  ...
  const fs = DateTime.fromFormat('1982/05/25 09:10:11.445', 'yyyy/MM/dd HH:mm:ss.SSS')
