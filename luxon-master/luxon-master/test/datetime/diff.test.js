...
test('DateTime#diff passes through options', () => {
  ...
  const dt2 = DateTime.fromObject({ year: 2016, month: 1, day: 1 })
  const dur1 = dt1.diff(dt2, 'hours', { conversionAccuracy: 'longterm' })
  const dur2 = dt1.diff(dt2, 'days', { conversionAccuracy: 'longterm' })
